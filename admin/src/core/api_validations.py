...
class SiteListParams:
    ...
    def from_request(cls, req):
        ...
        # Función auxiliar para parsear booleano o usar valor por defecto
        def parse_bool(param_name, default_value):
            value = args.get(param_name)
            if value is None:
            ...
            if value_lower in ('false', '0', 'f', 'n', 'no'):
                return False
            raise ValueError(f"El parámetro '{param_name}' debe ser un valor booleano")
        ...
        try:
            ...
            return cls(
                ...
                order_by=args.get('order_by', 'registrado'),
